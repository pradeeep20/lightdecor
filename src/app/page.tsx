    ...
    <div className="min-h-screen bg-[#0f172a] text-white font-sans">
      ...
      <section className="px-6 md:px-20 py-16 bg-gradient-to-r from-[#1e293b]/80 via-[#0f172a]/70 to-[#1e293b]/80 rounded-b-3xl">
        ...
        <p className="mb-3 text-gray-300">
          We provide top-notch lighting and decoration services to turn your
          events into memorable experiences.
        </p>
        <p className="mb-6 text-gray-400">
          Our mission is to create beautiful, ambient, and elegant spaces that
      ...
      <section className="px-6 md:px-20 py-16">
        ...
        {isLoadingRecentWork ? (
          ...
          <p className="text-gray-400">
            Add images to /public/images/recent-work to showcase your latest
            projects.
          </p>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            {recentWorkImages
              ...
              .reverse() // ② Reverse order (latest comes first)
              .map(
                (
                  img,
                  idx // ③ Loop through reversed array
                ) => (
                  <div
                    key={img.filename}
      ...
      <section className="px-6 md:px-20 py-16 bg-[#1e293b] rounded-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-start">
          {howItWorksSteps.map((step, idx) => (
            <div
              key={idx}
              className="bg-[#243045] p-4 rounded-xl shadow-md text-center flex flex-col items-center"
            >
              <img
                src={step.img}
                alt={step.title}
              ...
              {idx < 4 && (
                <span className="text-yellow-500 text-2xl mt-2">→</span>
              )}
            </div>
          ))}
        </div>
