      ...
      <div className="max-w-5xl mx-auto bg-[#1e293b] shadow-xl rounded-xl p-6 md:p-10 border border-white/10">
        ...
        >
          <input
            ...
            className="border border-white/20 bg-transparent text-white p-3 rounded-md w-full outline-none"
            value={formData.name}
          ...
          <textarea
            ...
            className="border border-white/20 bg-transparent text-white p-3 rounded-md w-full md:col-span-2 outline-none"
            rows={3}
          ...
          <button
            type="submit"
            className="md:col-span-2 bg-yellow-500 text-black font-semibold py-3 rounded-md hover:bg-yellow-400 transition"
          >
            Submit Inquiry
          </button>
        </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#243045] p-6 rounded-lg shadow-sm border border-white/10">
            <h3 className="text-lg font-semibold mb-2 text-white">
              Light Decor Inspiration
            </h3>
            <p className="text-white/80 leading-relaxed">
              Transform your events with our exquisite lighting designs. From
              ambient glows to luxurious chandeliers, we create mesmerizing
              atmospheres that leave lasting impressions. Every corner shines
              with elegance, making your special moments truly unforgettable.
            </p>
          </div>
